...
ATLASSIAN_TOKEN=<COPY YOUR ATLASSIAN SERVICE ACCOUNT TOKEN>
ATLASSIAN_API_URL=<COPY YOUR ATLASSIAN API ENDPOINT. Example https://atlassian.example.com/api/v1>
ATLASSIAN_VERIFY_SSL=<SET ATLASSIAN SSL VERIFICATION. true | false>
```

...
from ai_platform_engineering.agents.template.agent_petstore.agentcard import (
    create_agent_card,
    agent_skill,
)
...
AGENT_HOST = os.getenv("PETSTORE_AGENT_HOST", "localhost")
AGENT_PORT = os.getenv("PETSTORE_AGENT_PORT", "8000")

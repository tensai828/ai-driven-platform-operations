...
- **Ingestors:** Modular data ingestion from AWS, Kubernetes, Backstage, and other sources
...
2. **Graph Data Ingestion:** Ingestors pull data from various sources into the graph database (Neo4j).
...
- Integration with ingestors (AWS, K8s, Backstage, URLs)
...
### Ingestors
Modular ingestors support various data sources to ingest into the graph database:
- **AWS Ingestor:** Ingests AWS resources
- **Kubernetes Ingestor:** Pulls K8s cluster resources
- **Backstage Ingestor:** Pulls Backstage service catalogs

...
API_URL = os.getenv("BACKSTAGE_URL")
API_TOKEN = os.getenv("BACKSTAGE_API_TOKEN")

if not API_URL:
    raise ValueError("BACKSTAGE_URL environment variable is not set.")
if not API_TOKEN:
    raise ValueError("BACKSTAGE_API_TOKEN environment variable is not set.")

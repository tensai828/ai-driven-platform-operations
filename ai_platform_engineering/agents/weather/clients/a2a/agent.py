...
from ai_platform_engineering.agents.weather.agent_weather.agentcard import (
    create_agent_card,
    agent_skill,
)
...
AGENT_HOST = os.getenv("WEATHER_AGENT_HOST", "localhost")
AGENT_PORT = os.getenv("WEATHER_AGENT_PORT", "8000")

"""PetStore application models for MCP"""
...
class ApplicationStatus:
    """
    Status of a PetStore application
    """
...
def application_to_api_format(app: Application) -> Dict[str, Any]:
    """
    Convert an Application object to the format expected by PetStore API

    Args:
        app: Application object

    Returns:
        Dictionary in PetStore API format
    """
    source = {
...
def api_format_to_application(data: Dict[str, Any]) -> Application:
    """
    Convert PetStore API response to an Application object

    Args:
        data: Dictionary from PetStore API

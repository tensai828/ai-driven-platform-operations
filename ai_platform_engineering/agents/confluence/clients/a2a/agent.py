...
from ai_platform_engineering.agents.confluence.agent_confluence.agentcard import (
    create_agent_card,
    agent_skill,
)
...
AGENT_HOST = os.getenv("CONFLUENCE_AGENT_HOST", "localhost")
AGENT_PORT = os.getenv("CONFLUENCE_AGENT_PORT", "8000")

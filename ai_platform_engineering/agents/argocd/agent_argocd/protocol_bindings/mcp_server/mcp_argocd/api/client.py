...
async def make_api_request(
  ...
  # Check if MCP_VERIFY_SSL is set
  verify_ssl = not bool(os.getenv("MCP_VERIFY_SSL"))
  if not verify_ssl:
    logger.warning("MCP_VERIFY_SSL is set to false: SSL certificate verification is disabled.")

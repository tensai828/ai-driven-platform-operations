...
from ai_platform_engineering.agents.komodor.agent_komodor.agentcard import (
    create_agent_card,
    agent_skill,
)
...
AGENT_HOST = os.getenv("KOMODOR_AGENT_HOST", "localhost")
AGENT_PORT = os.getenv("KOMODOR_AGENT_PORT", "8000")

...
from ai_platform_engineering.multi_agents.incident_engineer.supervisor_agent import (
  AIIncidentEngineerMAS,
)
...
class AIIncidentEngineerA2ABinding:
  """
  ...
  def __init__(self):
      self.graph = AIIncidentEngineerMAS().get_graph()
      self.tracing = TracingManager()

  @trace_agent_stream("incident_engineer")

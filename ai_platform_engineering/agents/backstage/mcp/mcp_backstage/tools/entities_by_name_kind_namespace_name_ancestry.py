...
async def get_entity_ancestry_by_name(path_kind: str, path_namespace: str, path_name: str) -> Any:
  '''
  ...
  Returns:
      Any: The JSON response containing the entity's ancestry information.
  ...
  success, response = await make_api_request(
    f"/entities/by-name/{path_kind}/{path_namespace}/{path_name}/ancestry", method="GET", params=params, data=data
  )

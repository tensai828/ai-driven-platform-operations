...
async def repository_service__create_repository(
    ...
    Args:
        ...
        body_githubAppID (int, optional): GitHub App ID for authentication. Defaults to None.
        body_githubAppInstallationID (int, optional): GitHub App Installation ID for authentication. Defaults to None.
        body_githubAppPrivateKey (str, optional): Private key for GitHub App authentication. Defaults to None.
        body_inheritedCreds (bool, optional): Specifies whether credentials are inherited. Defaults to None.
        body_insecure (bool, optional): Specifies whether to allow insecure connections. Defaults to None.
        ...
        body_noProxy (str, optional): No proxy setting for the repository. Defaults to None.
        ...
        body_proxy (str, optional): Proxy setting for the repository. Defaults to None.

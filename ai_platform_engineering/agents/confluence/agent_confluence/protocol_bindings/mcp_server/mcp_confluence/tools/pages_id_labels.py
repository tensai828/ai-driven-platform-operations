...
"""Tools for /pages/{id}/labels operations"""
...
async def get_page_labels(path_id: int, param_prefix: str = None, param_sort: str = None, param_cursor: str = None, param_limit: int = None) -> Dict[str, Any]:
    """
    Get labels for page
...
Only labels that the user has permission to view will be returned.
    ...
    Args:
        ...
        path_id (int): The ID of the page for which labels should be returned.
    
        param_prefix (str): Filter the results to labels based on their prefix.
    ...
    """
    logger.debug("Making GET request to /pages/{id}/labels")

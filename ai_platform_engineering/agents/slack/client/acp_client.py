...
#     # Create configuration for both LLM provider and Slack
#     configurable_dict = {
#       # LLM config
...
#       # Slack config - required by the agent
#       "slack_bot_token": os.getenv("SLACK_BOT_TOKEN"),
#       "slack_app_token": os.getenv("SLACK_APP_TOKEN")
#     }
    
#     # Optional: Add allowed channels if defined
#     slack_team_id = os.getenv("SLACK_TEAM_ID")
#     if slack_team_id:
#         configurable_dict["allowed_channels"] = [slack_team_id]
    
#     # Ensure all message types are valid
#     run_create = RunCreateStateless(
#       agent_id=agent_id,
#       input=input_obj,
#       config=Config(configurable=configurable_dict),
#     )

...
async def get_api_v2_svc_yaml(
  param_cluster: str, param_namespace: str, param_kind: Literal["Deployment", "DaemonSet", "StatefulSet", "Rollout"], param_name: str
) -> Any:
  """
  Get service YAML
  ...
  Args:
      ...
      param_kind (Literal['Deployment', 'DaemonSet', 'StatefulSet', 'Rollout']): The kind of the service

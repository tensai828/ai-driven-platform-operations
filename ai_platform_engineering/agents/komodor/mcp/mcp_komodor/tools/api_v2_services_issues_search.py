...
async def post_api_v2_svcs_issues_search(
  ...
  body_scope_workflow_run: Optional[str] = None,
  ...
  success, response = await make_api_request("/api/v2/services/issues/search", method="POST", params=params, data=data)

...
const integrations = [
  ...
  },
  {
    name: "Kubernetes",
    color: "#326CE5",
    // Kubernetes helm wheel ⎈ symbol - clean and recognizable
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
        {/* Simple helm wheel design */}
        <circle cx="12" cy="12" r="10" fill="none" stroke="currentColor" strokeWidth="2"/>
        <circle cx="12" cy="12" r="3"/>
        {/* 7 spokes like the Kubernetes logo */}
        <line x1="12" y1="2" x2="12" y2="9" stroke="currentColor" strokeWidth="2"/>
        <line x1="12" y1="15" x2="12" y2="22" stroke="currentColor" strokeWidth="2"/>
        <line x1="2.5" y1="7.5" x2="9" y2="10.5" stroke="currentColor" strokeWidth="2"/>
        <line x1="15" y1="13.5" x2="21.5" y2="16.5" stroke="currentColor" strokeWidth="2"/>
        <line x1="2.5" y1="16.5" x2="9" y2="13.5" stroke="currentColor" strokeWidth="2"/>
        <line x1="15" y1="10.5" x2="21.5" y2="7.5" stroke="currentColor" strokeWidth="2"/>
      </svg>
    )
  },
  {
  ...
  },
  {
    name: "Backstage",
    color: "#36BAA2",
    // Backstage logo - simple bold B
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
        {/* Clean bold B letter */}
        <path d="M5 3h7c3 0 5 1.5 5 4.5 0 2-1 3.5-3 4 2.5.5 4 2.5 4 4.5 0 3-2.5 5-6 5H5V3zm4 7h2.5c1.5 0 2.5-.8 2.5-2s-1-2-2.5-2H9v4zm0 7h3c1.5 0 2.5-.8 2.5-2s-1-2-2.5-2H9v4z"/>
      </svg>
    )
  },
  {
  ...
  },
  {
    name: "Linux",
    color: "#333333",
    // Simple penguin silhouette - Tux
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
        {/* Simplified Tux penguin */}
        <ellipse cx="12" cy="14" rx="7" ry="8" fill="currentColor"/>
        <circle cx="12" cy="6" r="4.5" fill="currentColor"/>
        {/* Eyes */}
        <circle cx="10" cy="5.5" r="1" fill="#333333" stroke="white" strokeWidth="1.5"/>
        <circle cx="14" cy="5.5" r="1" fill="#333333" stroke="white" strokeWidth="1.5"/>
        {/* Belly - white oval */}
        <ellipse cx="12" cy="15" rx="4" ry="5" fill="white"/>
        {/* Beak */}
        <path d="M10.5 7.5 L12 9 L13.5 7.5 Z" fill="#FFA500"/>
        {/* Feet */}
        <ellipse cx="9" cy="21.5" rx="2" ry="1" fill="#FFA500"/>
        <ellipse cx="15" cy="21.5" rx="2" ry="1" fill="#FFA500"/>
      </svg>
    )
  },
];

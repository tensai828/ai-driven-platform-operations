...
class JiraAgent(BaseLangGraphAgent):
    ...
    SYSTEM_INSTRUCTION = scope_limited_agent_instruction(
        ...
        additional_guidelines=[
            ...
            "MANDATORY - Text Search in JQL: When searching for keywords, topics, or text content (e.g., 'incident', 'debug', 'error'), ALWAYS use 'text ~ \"keyword\"' instead of 'summary ~ \"keyword\"'",

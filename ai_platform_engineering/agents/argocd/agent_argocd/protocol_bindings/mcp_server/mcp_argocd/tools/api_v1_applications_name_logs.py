...
async def application_service__pod_logs2(
    ...
    Args:
        ...
        param_container (str, optional): The name of the container. Defaults to None.
        param_sinceSeconds (str, optional): The time in seconds since the logs should be retrieved. Defaults to None.
        ...
        param_untilTime (str, optional): The time until which the logs should be retrieved. Defaults to None.
        ...
        param_previous (bool, optional): Whether to retrieve logs for the previous instance of the container. Defaults to False.
        param_appNamespace (str, optional): The namespace of the application. Defaults to None.
        param_project (str, optional): The project name. Defaults to None.
        param_matchCase (bool, optional): Whether to match case in the filter. Defaults to False.

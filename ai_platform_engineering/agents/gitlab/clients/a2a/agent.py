...
from ai_platform_engineering.agents.gitlab.agent_gitlab.agentcard import (
    create_agent_card,
    agent_skill,
)
...
AGENT_HOST = os.getenv("GITLAB_AGENT_HOST", "localhost")
AGENT_PORT = os.getenv("GITLAB_AGENT_PORT", "8000")

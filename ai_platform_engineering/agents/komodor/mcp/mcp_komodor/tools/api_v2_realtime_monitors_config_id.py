...
async def get_api_id(path_id: str) -> Any:
  """
  ...
  success, response = await make_api_request(f"/api/v2/realtime-monitors/config/{path_id}", method="GET", params=params, data=data)
...
async def put_api_id(
  ...
  success, response = await make_api_request(f"/api/v2/realtime-monitors/config/{path_id}", method="PUT", params=params, data=data)
...
async def del_api_id(path_id: str) -> Any:
  """
  ...
  success, response = await make_api_request(f"/api/v2/realtime-monitors/config/{path_id}", method="DELETE", params=params, data=data)
